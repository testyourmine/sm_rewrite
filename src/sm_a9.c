...
void MotherBrainsBrain_Init(void) {  // 0xA98705
  ...
  E1->base.properties |= kEnemyProps_BlockPlasmaBeam | kEnemyProps_Invisible;
...
void MotherBrainsBody_Hurt(void) {  // 0xA9873E
  ...
  if (Get_MotherBrain(0x40)->mbn_var_02)
    unpause_hook = (LongPtr)LONGPTR(fnMotherBrainsBody_UnpauseHook);
}
...
void MotherBrainsBody_FirstPhase_DoubleRet(void) {  // 0xA987E1
  if (CheckEventHappened(kEvent_2_MotherBrainGlassBroken)) {
    Enemy_MotherBrain *E1 = Get_MotherBrain(0x40);
    E1->brain_shake_timer = earthquake_timer;
    if (samus_x_pos < 236) {
      if (E1->base.health == 0) {
        Enemy_MotherBrain *E = Get_MotherBrain(0);
        E->delete_turrets_rinkas_flag = 1;
        E->mbn_state = 1;
...
void MotherBrainBody_FakeDeath_Descent_4(void) {  // 0xA98884
  ...
  if ((--E->mbn_var_F & 0x8000) != 0) {
    ...
    E->mbn_var_F = 0;
    E->mbn_var_37 = 0;
    SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 14, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B6B3_MotherBrainsRoom_ClearCeilingBlock });
  }
}

void MotherBrainBody_FakeDeath_Descent_5(void) {  // 0xA988B2
  Enemy_MotherBrain *E = Get_MotherBrain(0);
  if ((int16)--E->body_func_timer < 0) {
    E->body_func_timer = 8;
    uint16 fade_idx = E->palette_fade_transition_counter++;
    if (MotherBrain_FadeToGray_FakeDeath(fade_idx))
      E->enemy_func = FUNC16(MotherBrainBody_FakeDeath_Descent_6);
  }
...
void MotherBrainBody_1_ClearBottomLeftTube(void) {  // 0xA9896E
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 5, .y_pos = 9, .plm_id_ = addr_kPlmHeader_B6C3_MotherBrain_ClearBottomLeftTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_3_ClearCeilingBlock9(void) {  // 0xA989A0
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 9, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B6B3_MotherBrainsRoom_ClearCeilingBlock });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_4_ClearCeilingBlock6(void) {  // 0xA989D2
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 6, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B6B3_MotherBrainsRoom_ClearCeilingBlock });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_6_ClearBottomRightTube(void) {  // 0xA989FA
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 10, .y_pos = 9, .plm_id_ = addr_kPlmHeader_B6C7_MotherBrain_ClearBottomRightTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_8_ClearBottomMiddleLeftTube(void) {  // 0xA98A22
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 6, .y_pos = 10, .plm_id_ = addr_kPlmHeader_B6BB_MotherBrain_ClearBottomMiddleSideTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_10_ClearCeilingTubeColumn7(void) {  // 0xA98A54
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 7, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B6B7_MotherBrainsRoom_ClearCeilingTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_12_ClearCeilingTubeColumn8(void) {  // 0xA98A86
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 8, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B6B7_MotherBrainsRoom_ClearCeilingTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_14_ClearBottomMiddleRightTube(void) {  // 0xA98AAE
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 9, .y_pos = 10, .plm_id_ = addr_kPlmHeader_B6BB_MotherBrain_ClearBottomMiddleSideTube });
  Enemy_MotherBrainBody *E = Get_MotherBrainBody(0x40);
...
void MotherBrainBody_16_ClearBottomMiddleTubes(void) {  // 0xA98AD6
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 7, .y_pos = 7, .plm_id_ = addr_kPlmHeader_B6BF_MotherBrain_ClearBottomMiddleTubes });
...
void MotherBrainBody_FakeDeath_Ascent_0_DrawBG1Row23(void) {  // 0xA98C87
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 2, .plm_id_ = addr_kPlmHeader_B67B_MotherBrainsRoom_BgRow2 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 3, .plm_id_ = addr_kPlmHeader_B67F_MotherBrainsRoom_BgRow3 });
...
void MotherBrainBody_FakeDeath_Ascent_1_DrawBG1Row45(void) {  // 0xA98C9E
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 4, .plm_id_ = addr_kPlmHeader_B683_MotherBrainsRoom_BgRow4 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 5, .plm_id_ = addr_kPlmHeader_B687_MotherBrainsRoom_BgRow5 });
...
void MotherBrainBody_FakeDeath_Ascent_2_DrawBG1Row67(void) {  // 0xA98CB5
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 6, .plm_id_ = addr_kPlmHeader_B68B_MotherBrainsRoom_BgRow6 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 7, .plm_id_ = addr_kPlmHeader_B68F_MotherBrainsRoom_BgRow7 });
...
void MotherBrainBody_FakeDeath_Ascent_3_DrawBG1Row89(void) {  // 0xA98CCC
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 8, .plm_id_ = addr_kPlmHeader_B693_MotherBrainsRoom_BgRow8 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 9, .plm_id_ = addr_kPlmHeader_B697_MotherBrainsRoom_BgRow9 });
...
void MotherBrainBody_FakeDeath_Ascent_4_DrawBG1RowAB(void) {  // 0xA98CE3
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 10, .plm_id_ = addr_kPlmHeader_B69B_MotherBrainsRoom_BgRow10 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B69F_MotherBrainsRoom_BgRow11 });
...
void MotherBrainBody_FakeDeath_Ascent_5_DrawBG1RowCD(void) {  // 0xA98CFA
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 12, .plm_id_ = addr_kPlmHeader_B6A3_MotherBrainsRoom_BgRow12 });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 2, .y_pos = 13, .plm_id_ = addr_kPlmHeader_B6A7_MotherBrainsRoom_BgRow13 });
...
void MotherBrainBody_FakeDeath_Ascent_9_PrepareRise(void) {  // 0xA98D8B
  ...
  if ((--E->mbn_var_F & 0x8000) != 0) {
    ...
    Enemy_MotherBrain *E1 = Get_MotherBrain(0x40);
    E1->base.properties |= kEnemyProps_Invisible;
    MotherBrain_SetBrainInstrs(addr_kMotherBrain_Ilist_Initial);
...
void MotherBrainBody_FakeDeath_Ascent_15_TransitionFromGrey(void) {  // 0xA98EAA
  Enemy_MotherBrain *E0 = Get_MotherBrain(0);
  if ((int16)--E0->body_func_timer < 0) {
    E0->body_func_timer = 4;
    uint16 fade_idx = E0->palette_fade_transition_counter++;
    if (MotherBrain_FadeFromGray_FakeDeath(fade_idx)) {
      Enemy_MotherBrain *E1 = Get_MotherBrain(0x40);
      E1->brain_palette_handling_enabled = 1;
      E0->mbn_state = 2;
      E1->drool_enabled_flag = 1;
      E1->lower_neck_movement_index = 6;
      E1->upper_neck_movement_index = 6;
      E1->neck_angle_delta = 0x500;
      E0->enemy_func = FUNC16(MotherBrainBody_2ndphase_16_ShakeHeadMenacingly);
      E0->body_func_timer = 23;
    }
  }
}
...
void MotherBrain_DrawNeck(void) {  // 0xA99303
  if (!(Get_MotherBrain(0)->base.properties & kEnemyProps_Invisible)) {
    Enemy_MotherBrain *E = Get_MotherBrain(0x40);
...
void MotherBrain_Phase3_Death_3(void) {  // 0xA9AF54
  ...
  if ((int16)--E->body_func_timer < 0) {
    Enemy_MotherBrain *E1 = Get_MotherBrain(0x40);
    E1->lower_neck_movement_index = 0;
    E1->upper_neck_movement_index = 0;
    E1->drool_enabled_flag = 0;
    E1->purple_breath_enabled_flag = 0;
    E1->brain_palette_handling_enabled = 0;
    E1->health_based_palette_handling_enabled = 0;
    MemCpy(palette_buffer.sprite_pal_7 + 1, palette_buffer.sprite_pal_1 + 1, 29);
    MotherBrain_HealthBasedPaletteHandling();
    E->brain_palette_index = 0xE00;
    E1->death_explosion_interval_timer = 0;
    E1->death_explosion_index = 0;
    E->enemy_func = FUNC16(MotherBrain_Phase3_Death_4);
...
void MotherBrain_Phase3_Death_5(void) {  // 0xA9AFB6
  ...
  Enemy_MotherBrain *E = Get_MotherBrain(0);
  if ((int16)--E->body_func_timer < 0) {
    E->body_func_timer = 16;
    uint16 fade_idx = E->palette_fade_transition_counter++;
    if (MotherBrain_FadePalToBlack(fade_idx)) {
      enemy_bg2_tilemap_size = 710;
      memset7E(tilemap_stuff, 0x338, enemy_bg2_tilemap_size + 2);
      nmi_flag_bg2_enemy_vram_transfer = 1;
      E->base.properties = E->base.properties & ~(kEnemyProps_ProcessInstructions) | kEnemyProps_Invisible;
      E->base.extra_properties = 0;
      E->enemy_func = FUNC16(MotherBrain_Phase3_Death_6);
      E->body_func_timer = 16;
    }
  }
}
...
void MotherBrain_Phase3_Death_11(void) {  // 0xA9B189
  ...
  if ((int16)--E->body_func_timer < 0) {
    uint16 fade_idx = E->palette_fade_transition_counter++;
    if (MotherBrain_FadeToGray_RealDeath(fade_idx)) {
      MotherBrain_SetBrainInstrs(addr_kMotherBrain_Ilist_Corpse);
      E->enemy_func = FUNC16(MotherBrain_Phase3_Death_12);
      E->body_func_timer = 256;
    }
    else {
      E->body_func_timer = 16;
    }
...
void MotherBrain_Phase3_Death_13(void) {  // 0xA9B1D5
  if (ProcessCorpseRotting(0x40) & 1) {
    ...
    E1->base.properties = E1->base.properties & ~(kEnemyProps_ProcessInstructions) | kEnemyProps_Invisible;
...
void MotherBrain_Phase3_Death_16_StartEscape(void) {  // 0xA9B26D
  if (ProcessSpriteTilesTransfers(0xa9, addr_kMotherBrainExplodeEscapeDoor_SpriteTileTransfers)) {
    ...
    earthquake_timer = -1;
    SpawnPalfxObject(addr_kPalfx_Tourian_8_RedFlashing_Shutter);
    SpawnPalfxObject(addr_kPalfx_Tourian_16_RedFlashing_Background);
    SpawnPalfxObject(addr_kPalfx_Tourian_32_RedFlashing_GeneralLevel);
    SpawnPalfxObject(addr_kPalfx_Tourian_64_RedFlashing_ArkanoidBlocksAndOrbs);
...
void MotherBrain_Phase3_Death_20_BlowUpEscapeDoor(void) {  // 0xA9B32A
  ...
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 0, .y_pos = 6, .plm_id_ = addr_kPlmHeader_B677_MotherBrainsRoom_EscapeDoor });
}
...
void MotherBrain_DrainedByShitroid_7(void) {  // 0xA9BF95
  ...
  if ((int16)--E->body_func_timer < 0) {
    E->body_func_timer = 16;
    uint16 fade_idx = E->palette_fade_transition_counter++;
    if (MotherBrain_FadeToGray_Drained(fade_idx)) {
      Enemy_MotherBrain *E1 = Get_MotherBrain(0x40);
      E1->base.health = 36000;
      E->phase2_corpse_state = 1;
      E1->purple_breath_enabled_flag = 0;
      E->mbn_state = 2;
      E->enemy_func = FUNC16(MotherBrain_Phase2_Revive_0);
    }
  }
}
...
void MotherBrain_Phase2_Revive_3(void) {  // 0xA9C08F
  ...
  if ((int16)--E->body_func_timer < 0) {
    E->body_func_timer = 16;
    uint16 fade_idx = E->palette_fade_transition_counter++;
    if (MotherBrain_FadeFromGray_Drained(fade_idx)) {
      E->enemy_func = FUNC16(MotherBrain_Phase2_Revive_4);
      Get_MotherBrain(0x40)->brain_palette_handling_enabled = 1;
      MotherBrain_SetupBrainNormalPal();
...
void ShitroidInCutscene_FinalCharge(uint16 k) {  // 0xA9CBD8
  ...
  Enemy_ShitroidInCutscene *E = Get_ShitdroidInCutscene(k);
  if (E->base.health == 0) {
    E->palette_func = FUNC16(nullsub_338);
    E->base.vram_tiles_index = 0x10A0;
    ...
    E->x_velocity = 0;
    E->y_velocity = 0;
    Get_MotherBrain(0)->enemy_func = addr_kMotherBrain_Instr_StopBody;
    QueueMusic_Delayed8(kMusic_Stop);
    E->enemy_func = FUNC16(ShitroidInCutscene_ShitroidFinalBelow);
    E->enemy_func_timer = 16;
    E->shaking_origin_x_pos = E->base.x_pos;
    E->shaking_origin_y_pos = E->base.y_pos;
...
void ShitroidInCutscene_FinishCutscene(uint16 k) {  // 0xA9CCF0
  Enemy_ShitroidInCutscene *E = Get_ShitdroidInCutscene(0);
  uint16 fade_idx = E->palette_fade_transition_counter++;
  if (MotherBrain_Phase3_TurnLightsBackOn(fade_idx)) {
    E->enemy_func = FUNC16(MotherBrain_Phase3_Recover_MakeDistance);
    ...
    Get_ShitdroidInCutscene(0x40)->enemy_index = 0;
  }
}
...
void MotherBrain_HandlePalette(void) {  // 0xA9D1E4
  Enemy_MotherBrain *E = Get_MotherBrain(0x40);
  if (E->brain_palette_handling_enabled)
    MotherBrain_HandleBrainPal();
  if (E->health_based_palette_handling_enabled)
    MotherBrain_HealthBasedPaletteHandling();
}
...
void WriteColorsToPalette(uint16 pal_idx, uint8 db, uint16 pal_ptr, uint16 num_colors) {  // 0xA9D2E4
  do {
    palette_buffer.pal[pal_idx >> 1] = *(uint16 *)RomPtrWithBank(db, pal_ptr);
    pal_idx += 2;
    pal_ptr += 2;
  } while (--num_colors);
}

void WriteColorsToTargetPalette(uint8 db, uint16 pal_idx, uint16 pal_ptr, uint16 num_colors) {  // 0xA9D2F6
  do {
    target_palettes.pal[pal_idx >> 1] = *(uint16 *)RomPtrWithBank(db, pal_ptr);
    pal_idx += 2;
    pal_ptr += 2;
  } while (--num_colors);
}
...
void DeadTorizo_Main(void) {  // 0xA9D368
  Enemy_DeadTorizo *E = Get_DeadTorizo(0);
  if (!(E->base.properties & kEnemyProps_Intangible) && DeadTorizo_Func_0() & 1) {
    E->base.properties |= kEnemyProps_Intangible;
...
void DeadTorizo_Powerbomb(void) {  // 0xA9D42A
  if (!(Get_DeadTorizo(0)->base.properties & kEnemyProps_Intangible))
    DeadTorizo_Shot();
}
...
void DeadSidehopper_Init_0(void) {  // 0xA9D7C4
  ...
  E->base.properties = E->base.properties & ~(kEnemyProps_EnableSamusColl) | kEnemyProps_ProcessedOffscreen;
...
void Shitroid_Func_GraduallyAccelerateTowards0x400(uint16 k, uint16 j, uint16 r18, uint16 r20) {  // 0xA9F451
  Shitroid_GraduallyAccelerateTowardsPt(k, j, r18, r20, 0x400);
}
