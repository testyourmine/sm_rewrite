...
void Crocomire_Func_37(void) {  // 0xA48D5E
  ...
  if (sign16(E0->base.x_pos - 1536)) {
    ...
    if (!g_word_7E9002) {
      g_word_7E9002 = 1;
      SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 97, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74B_Crocomire_CrumbleBlockInBridge });
    ...
    if (sign16(x_pos - 1568)) {
      ...
      if (!g_word_7E9006) {
        g_word_7E9006 = 1;
        SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 98, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74B_Crocomire_CrumbleBlockInBridge });
        SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 99, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74B_Crocomire_CrumbleBlockInBridge });
...
void Crocomire_8EE5(void) {  // 0xA48EE5
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 97, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 98, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 99, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 100, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 101, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 102, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 103, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 104, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 105, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 106, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B74F_Crocomire_ClearBlockInBridge });
  eproj_spawn_pt = (Point16U){ 1536, 176 };
  SpawnEprojWithRoomGfx(addr_kEproj_DustCloudExplosion, 0x15);
...
void Crocomire_Func_71(void) {  // 0xA4990A
  ...
  if (crocom_var_D) {
    ...
    E->crocom_var_F = 0;
    SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 32, .y_pos = 3, .plm_id_ = addr_kPlmHeader_B753_Crocomire_ClearInvisibleWall });
    SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 30, .y_pos = 3, .plm_id_ = addr_kPlmHeader_B757_Crocomire_CreateInvisibleWall });
    SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 112, .y_pos = 11, .plm_id_ = addr_kPlmHeader_B747_Crocomire_ClearBridge });
...
void Crocomire_Func_88(void) {  // 0xA49B06
  ...
  if (sign16(E->base.current_instruction + 0x1E3A)) {
    ...
    E->base.y_height = 28;
    E->base.x_width = 40;
    SpawnHardcodedPlm((SpawnHardcodedPlmArgs) { .x_pos = 48, .y_pos = 3, .plm_id_ = addr_kPlmHeader_B753_Crocomire_ClearInvisibleWall });
