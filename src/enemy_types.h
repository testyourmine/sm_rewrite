...
uint8 pad2[0x8000-0x7840];
  ...
  uint16 botwoon_var_PreDeathCounter;
  ...
  uint16 botwoon_var_DeathFlag;
  uint16 botwoon_var_BodyDeathFlag;
  ...
  uint16 botwoon_var_ShowingTailFlag;
...
uint16 function;
uint16 ssn_var_B;
uint16 spore_spawn_x_origin;
uint16 spore_spawn_y_origin;
uint16 ssn_var_E;
uint16 ssn_var_F_unused;
...
uint8 pad1[0x7800 - 0xFB8];
  ...
  uint16 ssn_var_02;
  uint16 ssn_var_03;
  uint16 stalk_x_origin;
  uint16 stalk_y_origin;
  uint16 ssn_var_06;
  uint16 ssn_var_07;
  uint16 ssn_var_08;
  uint16 ssn_var_09;
...
uint8 pad2[0x8000-0x7840];
  ...
  uint16 ssn_var_26;
  uint16 ssn_var_27;
  uint16 death_drift_x_speed;
  uint16 death_drift_x_subspeed;
  uint16 death_drift_y_speed;
  uint16 death_drift_y_subspeed;
  uint16 ssn_var_2C;
  uint16 ssn_var_2D;
  uint16 ssn_var_2E;
  uint16 damaged_flag;
  ...
  uint16 ssn_var_3F;
uint8 pad3[0x8800-0x8040];
  uint16 previous_health;
  uint16 ssn_var_41;
  uint16 ssn_var_42;
  uint16 death_drift_angle;
  uint16 ssn_var_44;
  uint16 ssn_var_45;
  uint16 ssn_var_46;
  uint16 ssn_var_47;
