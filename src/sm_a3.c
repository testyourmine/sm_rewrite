...
void Metalee_Func_5(void) {  // 0xA38A5C
  ...
  if (E->metalee_var_A-- == 1) {
    ...
    if (E->metalee_var_A == 8) {
      ...
      SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_DownRight);
      SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_UpRight);
      SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_DownLeft);
      SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_UpLeft);
    }
    ++E->base.y_pos;
  }
}
...
void Metalee_Shot(void) {  // 0xA38B0F
  ...
  if (!Get_Metalee(cur_enemy_index)->base.health) {
    ...
    uint16 v2 = cur_enemy_index;
    SpawnEprojWithGfx(E->metalee_var_A, cur_enemy_index, addr_kEproj_MetaleeParticles_DownRight);
    SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_UpRight);
    SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_DownLeft);
    SpawnEprojWithGfx(0, v2, addr_kEproj_MetaleeParticles_UpLeft);
    E->base.vram_tiles_index = 0;
...
void Skree_Func_4(void) {  // 0xA3C77F
  ...
  if (E->skree_var_A-- == 1) {
    ...
    if (E->skree_var_A == 8) {
      uint16 v2 = cur_enemy_index;
      SpawnEprojWithGfx(8, cur_enemy_index, addr_kEproj_SkreeParticles_DownRight);
      SpawnEprojWithGfx(0, v2, addr_kEproj_SkreeParticles_UpRight);
      SpawnEprojWithGfx(0, v2, addr_kEproj_SkreeParticles_DownLeft);
      SpawnEprojWithGfx(0, v2, addr_kEproj_SkreeParticles_UpLeft);
    }
    ++E->base.y_pos;
  }
}
...
void Skree_Shot(void) {  // 0xA3C7F5
  ...
  if (!E->base.health) {
    ...
    SpawnEprojWithGfx(E->skree_var_A, cur_enemy_index, addr_kEproj_SkreeParticles_DownRight);
    SpawnEprojWithGfx(0, v1, addr_kEproj_SkreeParticles_UpRight);
