...
enum Consts_87 {
  addr_kAnimtiles_IList_VerticalSpikes = 0x816A,
  addr_kAnimtiles_IList_HorizontalSpikes = 0x817E,
  addr_kAnimtiles_IList_CrateriaLake = 0x8192,
  addr_kAnimtiles_IList_CrateriaLava_Unused = 0x81A6,
  addr_kAnimtiles_IList_WreckedShipScreen = 0x81CB,
  addr_kAnimtiles_IList_WreckedShipTreadmillRight = 0x81E1,
  addr_kAnimtiles_IList_WreckedShipTreadmillLeft = 0x81F7,
  addr_kAnimtiles_IList_BrinstarMouth = 0x820D,
  addr_kAnimtiles_IList_MaridiaSandCeiling = 0x8221,
  addr_kAnimtiles_IList_MaridiaSandFalling = 0x8235,
  addr_kAnimtiles_IList_Nothing = 0x8249,
  ...
  addr_kAnimtiles_IList_Lava = 0x8293,
  addr_kAnimtiles_Lava = 0x82AB,
  addr_kAnimtiles_IList_Acid = 0x82B1,
  addr_kAnimtiles_Acid = 0x82C9,
  addr_kAnimtiles_IList_Rain = 0x82CF,
  addr_kAnimtiles_Rain = 0x82E7,
  addr_kAnimtiles_IList_Spores = 0x82ED,
  addr_kAnimtiles_Spores = 0x82FD,
  addr_kAnimtiles_IList_TourianStatue_Phantoon = 0x83AC,
  addr_kAnimtiles_IList_TourianStatue_Ridley = 0x8414,
  addr_kAnimtiles_IList_TourianStatue_Kraid = 0x847C,
  addr_kAnimtiles_IList_TourianStatue_Draygon = 0x84E4,
